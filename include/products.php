...
function get_products_all() {
    ...
    $products[102] = array(
    	"name" => "Mike the Frog Shirt, Magenta",
    ...
    $products[105] = array(
        "name" => "Mike the Frog Shirt, Brown",
    ...
    $products[123] = array(
            "name" => "Mike the Frog Shirt, Violet",
